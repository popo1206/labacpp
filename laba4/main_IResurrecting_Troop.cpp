...
TEST(IResurrecting_Troop_Constructor, defaultConstructor)
{
    IResurrecting_Troop I;
...
TEST(IResurrecting_Troop_Constructor, mainConstructor)
{
    Creature cr("Po", 5, 7, 1);
    School* sch = nullptr;
    Coordinates p0(0, 0);
    laba4::IResurrecting_Troop I( 1,5, 4, 2, 10, cr, sch, p0);
...
TEST(IResurrecting_Troop_Constructor, copyingConstructor)
{
    Creature cr("Po", 5, 7, 1);
    School* sch = nullptr;
    Coordinates p0(0, 0);
    laba4::IResurrecting_Troop I(1, 5, 4, 2, 10, cr, sch, p0);
    IResurrecting_Troop I1(I);
    ASSERT_EQ(I.get_dead_creatures(), 5);
    ASSERT_EQ(I.get_initiative(),1);
    ASSERT_EQ(I.get_p().x, 0);
    ASSERT_EQ(I.get_p().y, 0);
    ...
    ASSERT_EQ(I1.get_dead_creatures(), 5);
...
TEST(IResurrecting_Troop_Methods, ressurect_creatures)
{
    Creature cr("Po", 5, 7, 1);
    School* sch = nullptr;
    Coordinates p0(0, 0);
